...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'menus_food', 'last_date',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='last_date_food_was_offered', null=True, to=orm['menus.FoodDate']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Food.last_date'
        db.delete_column(u'menus_food', 'last_date_id')
