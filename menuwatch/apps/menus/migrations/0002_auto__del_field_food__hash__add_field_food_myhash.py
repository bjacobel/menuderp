...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Food._hash'
        db.delete_column(u'menus_food', '_hash')
    ...
    def backwards(self, orm):
        # Adding field 'Food._hash'
        db.add_column(u'menus_food', '_hash',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
    ...
    models = {
        ...
        u'menus.food': {
            ...
            'myhash': ('django.db.models.fields.IntegerField', [], {}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
