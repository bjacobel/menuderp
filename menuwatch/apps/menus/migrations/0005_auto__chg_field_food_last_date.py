...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Food.last_date'
        db.alter_column(u'menus_food', 'last_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Food.last_date'
        db.alter_column(u'menus_food', 'last_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 8, 29, 0, 0)))
    ...
    models = {
        ...
        u'menus.food': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'next_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 29, 0, 0)'}),
