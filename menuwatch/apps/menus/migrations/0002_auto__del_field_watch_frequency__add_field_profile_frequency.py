...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Watch.frequency'
        db.delete_column(u'menus_watch', 'frequency')

        # Adding field 'Profile.frequency'
        db.add_column(u'menus_profile', 'frequency',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Watch.frequency'
        db.add_column(u'menus_watch', 'frequency',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Deleting field 'Profile.frequency'
        db.delete_column(u'menus_profile', 'frequency')
