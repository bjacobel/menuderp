...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.onboarded'
        db.add_column(u'menus_profile', 'onboarded',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.onboarded'
        db.delete_column(u'menus_profile', 'onboarded')
    ...
    models = {
        ...
        u'menus.profile': {
            ...
            'onboarded': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
